...
import sys
sys.path.insert(0, "/home/jim/Documents/AI/fact/reproduction/ELDR-reproduction/scvis/lib/scvis/")
...
def load_vae(input_dim, model_file, feature_transform = None):
    ...
    # Model Configuration
    try:
        config_file_yaml = open("/home/jim/Documents/AI/fact/reproduction/ELDR-reproduction/scvis/lib/scvis/config/model_config.yaml", "r")
